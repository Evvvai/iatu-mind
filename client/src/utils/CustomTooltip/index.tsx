...
function ToolTip({
  ...
  const [saveTimerOut, setSaveTimerOut] = useState<ReturnType<typeof setTimeout> | null>(null)
  const [saveTimerOver, setSaveTimerOver] = useState<ReturnType<typeof setTimeout> | null>(null)
